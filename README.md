...
Despite this, AI use is not prohibited. The prototype for this project was accelerated considerably through AI. In particular, Codex has almost total autonomy over the test suite, which makes it fairly overengineered (sorry, I hate writing tests). That does not mean I am unfamiliar with the code structure or blindly accept the output. I constantly change AI generated details and test the program's effects on real hardware. You should do the same!
